...
class MelodyTestRunner {
  static List<MelodyTestCase> getTestCases() {
    return [
      ...
      MelodyTestCase(
        ...
        pitches: [
          PitchPoint(timeSec: 0.0, frequencyHz: 261.63, note: 'C4', cents: 0),  // C
          PitchPoint(timeSec: 0.5, frequencyHz: 293.66, note: 'D4', cents: 0),  // D
          PitchPoint(timeSec: 1.0, frequencyHz: 329.63, note: 'E4', cents: 0),  // E
          PitchPoint(timeSec: 1.5, frequencyHz: 349.23, note: 'F4', cents: 0),  // F
          PitchPoint(timeSec: 2.0, frequencyHz: 392.00, note: 'G4', cents: 0),  // G
          PitchPoint(timeSec: 2.5, frequencyHz: 440.00, note: 'A4', cents: 0),  // A
          PitchPoint(timeSec: 3.0, frequencyHz: 493.88, note: 'B4', cents: 0),  // B
          PitchPoint(timeSec: 3.5, frequencyHz: 523.25, note: 'C5', cents: 0),  // C
        ],
      ),
      ...
      MelodyTestCase(
        ...
        pitches: [
          PitchPoint(timeSec: 0.0, frequencyHz: 440.00, note: 'A4', cents: 0),  // A
          PitchPoint(timeSec: 0.5, frequencyHz: 493.88, note: 'B4', cents: 0),  // B
          PitchPoint(timeSec: 1.0, frequencyHz: 523.25, note: 'C5', cents: 0),  // C
          PitchPoint(timeSec: 1.5, frequencyHz: 587.33, note: 'D5', cents: 0),  // D
          PitchPoint(timeSec: 2.0, frequencyHz: 659.25, note: 'E5', cents: 0),  // E
          PitchPoint(timeSec: 2.5, frequencyHz: 698.46, note: 'F5', cents: 0),  // F
          PitchPoint(timeSec: 3.0, frequencyHz: 783.99, note: 'G5', cents: 0),  // G
          PitchPoint(timeSec: 3.5, frequencyHz: 880.00, note: 'A5', cents: 0),  // A
        ],
      ),
      ...
      MelodyTestCase(
        ...
        pitches: [
          PitchPoint(timeSec: 0.0, frequencyHz: 261.63, note: 'C4', cents: 0),  // C
          PitchPoint(timeSec: 0.5, frequencyHz: 329.63, note: 'E4', cents: 0),  // E
          PitchPoint(timeSec: 1.0, frequencyHz: 392.00, note: 'G4', cents: 0),  // G
          PitchPoint(timeSec: 1.5, frequencyHz: 523.25, note: 'C5', cents: 0),  // C
        ],
      ),
  ...
  static bool runSingleTest(MelodyTestCase test) {
    try {
      ...
      final suggestions = engine.suggest(ceNotes, keyResult.key, keyResult.isMinor);
      
      // Evaluate results
      bool keyCorrect = (keyResult.key == test.expectedKey && keyResult.isMinor == test.expectedMinor);
      bool hasChords = suggestions.isNotEmpty;
      
      print('Expected: ${test.expectedKey} ${test.expectedMinor ? 'minor' : 'major'}');
      print('Detected: ${keyResult.key} ${keyResult.isMinor ? 'minor' : 'major'} (${keyCorrect ? '✓' : '✗'})');
      print('Chord suggestions: ${hasChords ? suggestions.first.chords.map((c) => c.symbol).join(', ') : 'NONE'} (${hasChords ? '✓' : '✗'})');
